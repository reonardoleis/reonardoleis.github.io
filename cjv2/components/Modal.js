  ...
  <div class="my-modal">
    <div class="my-modal-content border-radius-primary">
      ...
      <div class="container p-3">
        ...
        <div class="container table-small-handler mt-5">
          <div class="mx-auto text-center mb-3">
            <div class="row mx-auto">
              ...
              <div class="col-4">
                <div class="bg-blue-dark rounded-pill" v-bind:class="{'disabled-circle': active_plan != 1}"
                  v-on:click="$emit('set_plan', '1')" style="width: 15px !important; height: 15px !important;"></div>
              </div>
              <div class="col-4">
                <div class="bg-blue-dark rounded-pill" v-bind:class="{'disabled-circle': active_plan != 2}"
                  v-on:click="$emit('set_plan', '2')" style="width: 15px !important; height: 15px !important;"></div>
              </div>
            </div>
          </div>
          <div class="container table-fixed-head p-0 mt-3 table-responsive mx-auto table-small-handler">
            <div v-if="active_plan == 0">
              <div class="p-3">
            ...
            <table class="table table-bordered border-radius-primary">
              ...
              <tr
                v-for="item in ['Suporte dentro do programa', 'Analistas especializados', 'Central de Ajuda (Guia Prático)', 'Vídeos Tutoriais', 'Tour Guiado']">
        ...
        <div class="container table-fixed-head p-0 mt-3 table-responsive table-big-handler">
          <table class="table table-bordered border-radius-primary">
            <thead>
              <tr>
                <th scope="col">
