    ...
    <div class="container bg-light">
        <div class="container-fluid fit">
            <div class="container center little-padding">
                ...
                <br>
                <label>(Para exportar como assemble, o que for varíavel deve iniciar com <strong>v</strong>. Exemplo: v100. <strong>OBS.: O v deve ser adicionado APENAS PARA EXPORTAÇÃO, caso contrário o código não irá funcionar.</strong>)</label>
                <br>
                <div class="row">
                    <div class="col-md-3">
